...
export default function ChatRoom() {
  ...
  return (
    <div className="flex flex-col -mx-4 -my-4" style={{ minHeight: 'calc(100dvh - var(--app-header-h, 96px) - var(--app-nav-h, 64px))', height: 'calc(100dvh - var(--app-header-h, 96px) - var(--app-nav-h, 64px))' }}>
      {/* Header */}
